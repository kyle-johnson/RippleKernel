...
KERN_OBJS = kernel.o boiler.o mm.o int30.o kbd_isr.o k_printf.o string.o putchar.o rwRegs.o real_time_clock.o rtc.o floppy.o tasks.o TSS.o tss-management.o
